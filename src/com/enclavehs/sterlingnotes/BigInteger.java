...
public class BigInteger {
     ...
     * @param offsetx offset of the buffer x
     * @param y the number y
     * @param offsety offset of buffer y
     * @param size size of the two numbers
     */
    public static boolean addCarry(byte[] x, short offsetx, byte[] y, short offsety, short size)
    {
        short akku = 0;
     ...
     */
    public static boolean addOneCarry(byte[] x, short offsetx, short size)
    {
     ...
     * size is the size in bytes of the operand x
     */
    public static boolean subtractOneCarry(byte[] x, short offsetx, short size) {
     ...
     */
    static boolean equalZero(byte[] x, short offsetx, short size) {
    ...
    public static void ShiftOneBit(byte[] src, short srcOffset, short size){
    ...
    public static void setZero(byte[] x, short offsetx, short size) {
        Util.arrayFillNonAtomic(x, offsetx, size, (byte)0x00);
    }
    ...
    public static short encodeShortToVarInt(short value, byte[] buffer, short offset) {
        ...
        if (isStrictlyLessThanUnsigned(value,(short)253)){
